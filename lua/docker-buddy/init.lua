...
local function set_all_buffer_keymaps(buf)
	api.nvim_buf_set_keymap(
		...
		"n",
		"R",
		"<Cmd>lua require('docker-buddy.actions').executeActionOnCurrentLine('restart')<CR>",
		{}
	)
	api.nvim_buf_set_keymap(
		buf,
		"n",
		"U",
		"<Cmd>lua require('docker-buddy.actions').executeActionOnCurrentLine('unpause')<CR>",
		{}
	)
	api.nvim_buf_set_keymap(
		buf,
		"n",
		"P",
		"<Cmd>lua require('docker-buddy.actions').executeActionOnCurrentLine('pause')<CR>",
		{}
	)
	api.nvim_buf_set_keymap(
		buf,
		"n",
		"E",
		"<Cmd>lua require('docker-buddy.actions').executeActionOnCurrentLine('connect')<CR>",
		{}
	)
end
